<!DOCTYPE html>
<!--
Template Name: {{env('APP_NAME')}} - Vuejs, HTML & Laravel Admin Dashboard Template
Author: PixInvent
Website: http://www.pixinvent.com/
Contact: hello@pixinvent.com
Follow: www.twitter.com/pixinvents
Like: www.facebook.com/pixinvents
Purchase: https://1.envato.market/{{env('APP_NAME')}}_admin
Renew Support: https://1.envato.market/{{env('APP_NAME')}}_admin
...
<head>
    ...
    <title>Login Page - {{env('APP_NAME')}} - Bootstrap HTML admin template</title>
            ...
            <div class="auth-wrapper auth-cover">
                <div class="auth-inner row m-0">
                    <!-- Brand logo--><a class="brand-logo" href="index.html">
                        ...
                        <h2 class="brand-text text-primary ms-1">{{ ucfirst($domain) }}</h2></a>
                    <!-- /Brand logo-->
                    <!-- Left Text-->
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <form class="auth-login-form mt-2" action="{{ route('client.login', ['domain' => $domain]) }}" method="post">
                                {{ csrf_field() }}
                                <div class="mb-1">
                            ...
                            <p class="text-center mt-2"><span>New on our platform?</span><a href="/client/register"><span>&nbsp;Create an account</span></a>
                            </p>
