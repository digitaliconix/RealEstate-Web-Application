...
<head>
    ...
    <title>Verify Email Basic - {{env('APP_NAME')}} - Bootstrap HTML admin template</title>
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <p class="card-text mb-2">
                                We've sent a link to your email address: <span class="fw-bolder">{{$user->email}}</span>
                                Please follow the
                                link inside to continue.
                            </p>

                            <a href="/client/logout" class="btn btn-primary w-100">Skip for now</a>

                            {{--                            <p class="text-center mt-2">--}}
                            {{--                                <span>Didn't receive an email? </span><a href=""><span>&nbsp;Resend</span></a>--}}
                            {{--                            </p>--}}
                            <form method="POST" action="{{ route('client.verification.resend') }}">
                                @csrf
                                <p class="text-center mt-2">
