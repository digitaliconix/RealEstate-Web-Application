...
<head>
    ...
    <title>Register Page - {{env('APP_NAME')}} - Bootstrap HTML admin template</title>
            ...
            <div class="auth-wrapper auth-cover">
                <div class="auth-inner row m-0">
                    <!-- Brand logo--><a class="brand-logo" href="index.html">
                        ...
                        <h2 class="brand-text text-primary ms-1">{{env('APP_NAME')}} Client</h2></a>
                    <!-- /Brand logo-->
                    <!-- Left Text-->
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <p class="text-center mt-2"><span>Already have an account?</span><a href="/client/login"><span>&nbsp;Sign in instead</span></a></p>
